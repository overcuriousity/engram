...
| `consolidate.*` | Duplicate hygiene: `enabled`, `near_dupe_min`, `review_min`, `auto_supersede`, `per_point`, `interval_hours`, `autonomous`, `dedupe_interval_mins`, `max_dedupe_per_tick`, `merge_max_roots`. |
